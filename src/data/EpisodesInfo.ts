export const episodesInfo = [
  ...
  },
  {
    ...
    "description": "Jerry dislikes Elaine's friend Wendy because she gives him a kiss on the cheek every time they meet. Wendy sports a somewhat dated hair style and neither Jerry nor Elaine really have the nerve to tell her so they come up with the perfect solution: introduce her to Kramer who is bound to blurt out some inappropriate comment. It doesn't quite go as planned. Kramer has decided that everyone in the building would be nicer to each other if they knew everyone's name and so puts up photos in the lobby. Soon Jerry has every woman in the building kissing him hello. He tries to stop it but faces dire consequences. George has a problem when he misses an appointment with Wendy and she wants to charge anyways. Jerry gets his parents arguing with his uncle Leo after revealing a family secret.",
  ...
  },
  {
    ...
    "episode_code": 7.2,
    "title": "The Calzone",
    "description": "After Yankees' owner George Steinrenner takes a liking to George's calzone, the two of them start having lunch at one o'clock every day. George gets into a bit of trouble however at the restaurant when the server thinks he's stealing money from the tip jar. He tries to get Newman to buy the sandwiches for him since the restaurant is on his mail route, but it falls apart when Newman calls in sick on a rainy day. Kramer doesn't have much luck either. Kramer has taken to warming his clothes before wearing them.",
